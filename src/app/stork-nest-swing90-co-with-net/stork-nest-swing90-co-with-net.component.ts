...
@Component({
  selector: 'app-stork-nest-swing90-co-with-net',
  standalone: true,
  imports: [RouterLink, RouterOutlet],
  templateUrl: './stork-nest-swing90-co-with-net.component.html',
  styleUrl: './stork-nest-swing90-co-with-net.component.css'
})
